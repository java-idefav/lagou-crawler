...
public class TbPositions {
    ...
    public String getPositionLabelList() {
        return positionLabelList;
    }

    public void setPositionLabelList(String positionLabelList) {
        this.positionLabelList = positionLabelList == null ? null : positionLabelList.trim();
    }
